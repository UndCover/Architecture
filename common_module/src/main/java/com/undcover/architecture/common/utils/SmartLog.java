...
public class SmartLog {
    ...
    private static int logLevel = LEVEL_V;
    private static SmartLog mLog;

    private synchronized static SmartLog getInstance() {
        if (mLog == null) {
     ...
     * @return
     */
    public static SmartLog setLogLevel(int logLevel) {
    ...
    private static boolean isLifeCycleEnable = true;
    private static boolean isNetWorkEnable = true;
    private static boolean isFrameWorkEnable = true;
    private static boolean isAtyManagerEnable = true;
     ...
     * @return
     */
    public static SmartLog setFilter(int filter) {
...
//        }
    ...
    public static SmartLog setDefaultTag(String tag) {
        SmartLog.TagConstant.TAG_APP = tag;
        return getInstance();
    }
